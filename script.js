document.addEventListener('DOMContentLoaded', () => {
    ...
    const latestUpdate = {
        version: '2.4.1',
        title: 'Huson-AI 2.4.1 穩定性修正',
        content: `* **修正**：修復了因 JavaScript 載入過快導致所有功能都癱瘓的白癡問題。`,
        imageSrc: '',
    ...
    if (SpeechRecognition) {
        ...
        recognition.onend = () => { isListening = false; micBtn.classList.remove('listening'); userInput.placeholder = '使用語音辨識或打字'; };
